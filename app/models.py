...
class Detection(Base):
    ...
    person_detected: Mapped[bool] = mapped_column(default=False, nullable=False)
    known_person_detected: Mapped[bool | None] = mapped_column(default=None)
    identity_matches_payload: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
